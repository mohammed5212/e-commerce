...
//    const token = createToken(admin._id, admin.role);
//     res.cookie("token", token, {
//   httpOnly: true,     // Protects against XSS (very important)
//   secure: false, 
//   path :"/",     // Set to true ONLY if using HTTPS. If local, keep false.
//   sameSite: "lax",    // Allows the cookie to be sent across "same-site" requests
